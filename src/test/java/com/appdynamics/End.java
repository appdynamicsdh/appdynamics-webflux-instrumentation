 ...
 */
public class End extends AGenericInterceptor {
    IReflector id = null;

    private static final String CLASS_TO_INSTRUMENT = "raaaaaaaaaax.internal.schedulers.ScheduledAction";
    private static final String METHOD_TO_INSTRUMENT = "run";
    ...
    public Object onMethodBegin(Object o, String s, String s1, Object[] objects) {
        AppdynamicsAgent.startSegment(o);
