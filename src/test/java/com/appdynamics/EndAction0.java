 ...
 */
public class EndAction0 extends AGenericInterceptor {
    IReflector id = null;

    private static final String CLASS_TO_INSTRUMENT = "rx.functions.Action0";
    private static final String METHOD_TO_INSTRUMENT = "call";
